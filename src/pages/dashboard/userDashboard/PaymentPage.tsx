...
const PaymentPage = () => {
    ...
    const stcPaymentInfo = "https://i.ibb.co.com/RGJTKgSZ/stc-logo.jpg"
        ...
        <Container className=" max-w-[600px] mx-auto ">
            <div className=" my-2 mx-2 p-4 rounded-md border border-blue-600">
                ...
                <div className="mt-5 flex justify-center items-center">
                    <img
                        className="w-[150px] "
                        src={method === "Nagad" ? nagad : method === "Rocket" ? rocket : method === "Binance" ? binanceLogo : method === "stc" ? stcPayLogo : bkash}
                        alt={method === "Nagad" ? "nagad" : method === "Rocket" ? "rocket" : method === "Binance" ? "Binance" : "bkash"}
                    />
                </div>
                ...
                <div className="mt-8">
                    <div className="flex  gap-5">
                        <div className="flex border w-full border-gray-300 p-2 rounded-md gap-3 items-center ">
                            <div>
                                <img
                ...
                <div className="mt-5">
                    ...
                    <div className={`w-full ${method === "Nagad" ? "bg-red-600" : method === "Bkash" ? "bg-[#e0126d]" : method === "stc" ? "bg-[#01c48c]"  : method ==="Binance" ? "bg-[#f3ba2f]" : "bg-[#8c3494]"} text-white rounded-md p-2 text-start`}>
                        {/* Apply list-disc and list-inside to the ul */}
                        {method === "Binance" ? <div className={`max-w-[500px] mx-auto bg-[#f3ba2f] flex justify-center items-center text-white rounded-md p-2 text-start`}>
                            <img src={Binance} alt="" />

                        </div> :
                            method === "stc" ? <div className={`max-w-[500px] mx-auto bg-[#fff] flex justify-center items-center text-white rounded-md p-2 text-start`}>
                                <img src={stcPaymentInfo} alt="" />
                            </div> :
